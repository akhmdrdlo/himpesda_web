            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
                ...
                <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                    <div class="flex items-center">
                        <h6 class="mb-0 text-lg">Detail Pendaftar: {{ $pendaftar->nama_lengkap }}</h6>
                        <a href="{{ route('admin.konfirmasi.index') }}" class="inline-block px-4 py-2 mb-0 ml-auto font-bold text-center text-white align-middle transition-all ease-in bg-slate-500 border-0 rounded-lg shadow-md cursor-pointer text-xs hover:shadow-xs hover:-translate-y-px active:opacity-85">
                            &laquo; Kembali
                        </a>
                    </div>
                </div>
