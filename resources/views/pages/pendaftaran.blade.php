...
<section class="max-w-3xl mx-auto p-6 md:py-16">
    ...
    @endif
    <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-xl shadow-lg space-y-6">
        @csrf
        {{-- Mengelompokkan input agar lebih rapi --}}
