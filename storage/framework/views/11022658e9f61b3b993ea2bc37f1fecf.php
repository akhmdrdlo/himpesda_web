...
<head>
    ...
    <style>
        ...
        /* Ukuran kartu vertikal, rasio mirip KTP/kartu kredit */
        .card-vertical {
            width: 20rem; /* 320px */
            height: 32rem; /* 512px */
        }
            ...
            <div class="card-vertical bg-gray-800 rounded-2xl shadow-lg overflow-hidden relative flex flex-col">
                ...
                <div class="relative z-10 p-6 flex flex-col h-full">
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 bg-white rounded-full p-1 shadow-md"><img src="<?php echo e(asset('assets/img/logo-ct-dark.png')); ?>" alt="Logo"></div>
                        <div>
                    ...
                    <div class="flex-grow flex flex-col items-center justify-center text-center mt-8">
                        <div class="w-32 h-40 border-4 border-white rounded-lg overflow-hidden shadow-lg">
                            <img src="<?php echo e($user->pas_foto ? asset('storage/' . $user->pas_foto) : asset('assets/img/team-1.jpg')); ?>" alt="Pas Foto" class="w-full h-full object-cover">
                        </div>
                        <h2 class="text-white font-bold text-2xl mt-4"><?php echo e($user->nama_lengkap); ?></h2>
                        <p class="text-yellow-300 font-semibold"><?php echo e($user->jabatan_fungsional ?? 'Anggota'); ?></p>
                    </div>
