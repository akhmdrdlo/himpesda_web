...
<body class="flex flex-col items-center justify-center min-h-screen p-8 printable-area">
    ...
    <div class="mb-8 no-print">
        ...
        <a href="<?php echo e(url()->previous()); ?>" class="px-6 py-2 font-semibold text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300">
            Kembali
        </a>
    </div>
        ...
        <div class="card-container bg-gray-800 rounded-2xl shadow-lg overflow-hidden relative flex flex-col">
            ...
            <div class="relative z-10 p-4 flex flex-col flex-grow">
                <div class="flex items-center space-x-2">
                    <div class="w-10 h-10 bg-white rounded-full p-1"><img src="<?php echo e(asset('assets/img/logo-ct-dark.png')); ?>" alt="Logo"></div>
                    <div>
                ...
                <div class="flex-grow flex items-center justify-center">
                    <div class="flex flex-col items-center w-full">
                        <div class="w-20 h-20 border-2 border-white rounded-md overflow-hidden shadow-md mb-2">
                            <img src="<?php echo e(asset('storage/' . $user->pas_foto)); ?>" alt="Pas Foto" class="w-full h-full object-cover">
                        </div>
                        <p class="text-white font-bold text-base text-center"><?php echo e($user->nama_lengkap); ?></p>
                        <p class="text-blue-200 text-xs text-center"><?php echo e($user->jabatan_fungsional ?? ''); ?></p>
                    </div>
                </div>
                <div class="text-white text-xs flex justify-between">
                    <div>
                        <p class="opacity-100">Unit Kerja</p>
                        <p class="font-semibold"><?php echo e($user->unit_kerja??'Karyawan'); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="opacity-100">No. Anggota</p>
                        <p class="font-semibold"><?php echo e($user->nomor_anggota ?? 'N/A'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-container bg-white rounded-2xl shadow-lg overflow-hidden relative flex flex-col">
            ...
            <div class="relative z-10 p-4 flex flex-col h-full">
                ...
                <div class="text-center my-2">
                    <div class="w-10 h-10 bg-white rounded-full p-1 mx-auto shadow-sm"><img src="<?php echo e(asset('assets/img/logo-ct-dark.png')); ?>" alt="Logo"></div>
                ...
                <div class="text-center">
                    ...
                    <p class="font-bold text-xs text-gray-800">
                        <?php echo e(\Carbon\Carbon::parse($user->created_at)->addYears(5)->locale('id')->isoFormat('D MMMM YYYY')); ?>
...
</html><?php /**PATH C:\laragon\www\himpesda-web\resources\views/admin/anggota/kartu-anggota.blade.php ENDPATH**/ ?>