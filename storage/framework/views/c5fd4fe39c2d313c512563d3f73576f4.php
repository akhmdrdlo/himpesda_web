...
<?php $component->withAttributes([]); ?>
    <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-[var(--blue-dark)] hover:text-blue-700 mb-4">
     ...
     <?php $__env->slot('logo', null, []); ?> 
        <a href="<?php echo e(route('home')); ?>" class="text-4xl font-bold text-[var(--blue-dark)]">
            HIMPESDA
        </a>
     <?php $__env->endSlot(); ?>   
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <button type="submit" class="ms-3 inline-flex items-center px-4 py-2 bg-[var(--blue-dark)] border border-transparent rounded-md font-semibold text-xs text-yellow-300 uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
...
<?php endif; ?><?php /**PATH C:\laragon\www\himpesda-web\resources\views/auth/login.blade.php ENDPATH**/ ?>